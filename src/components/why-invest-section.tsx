...
const investmentProblems = [
  {
    ...
    description: '<div class="space-y-4 md:space-y-6"><p class="text-lg md:text-2xl">"A economia do Brasil sempre foi caracterizada por instabilidade"</p><p class="text-sm md:text-lg leading-relaxed opacity-90 mt-3 md:mt-4">Desde a independência em 1822, o Brasil já nasceu em crise econômica. São mais de 200 anos alternando entre recessões, altas taxas de inflação, décadas perdidas e crescimento insuficiente. Enquanto isso, o brasileiro vê seu dinheiro sendo corroído.</p><div class="mt-6 md:mt-8 p-4 md:p-6 bg-white/10 rounded-lg"><p class="text-2xl md:text-3xl text-red-500">82%</p><p class="text-xs md:text-sm uppercase tracking-wide opacity-80 mt-1 md:mt-2">dos países do mundo cresceram mais que o Brasil na última década</p></div></div>',
  ...
  },
  {
    ...
    description: '<div class="space-y-4 md:space-y-6"><p class="text-lg md:text-2xl">"O governo não ensina você a investir"</p><p class="text-sm md:text-lg leading-relaxed opacity-90 mt-3 md:mt-4">Apenas 21% das crianças brasileiras recebem alguma educação financeira. O sistema foi projetado para formar funcionários obedientes, não investidores independentes. Enquanto isso, a elite financeira passa esse conhecimento de pai para filho.</p><div class="mt-6 md:mt-8 p-4 md:p-6 bg-white/10 rounded-lg"><p class="text-2xl md:text-3xl text-red-500">21%</p><p class="text-xs md:text-sm uppercase tracking-wide opacity-80 mt-1 md:mt-2">de educação financeira na infância</p></div></div>',
  ...
  },
  {
    ...
    description: '<div class="space-y-4 md:space-y-6"><p class="text-lg md:text-2xl">"77% das famílias estão endividadas"</p><p class="text-sm md:text-lg leading-relaxed opacity-90 mt-3 md:mt-4">61% não conseguem poupar nada do que ganham. 55% não controlam os gastos do cartão. 56% cedem aos impulsos de compra. A mentalidade do "vou aproveitar agora" está criando uma geração inteira sem patrimônio.</p><div class="mt-6 md:mt-8 flex flex-col sm:flex-row gap-3 md:gap-4"><div class="flex-1 p-4 md:p-6 bg-white/10 rounded-lg"><p class="text-2xl md:text-3xl text-red-500">77%</p><p class="text-xs md:text-sm uppercase tracking-wide opacity-80 mt-1 md:mt-2">das famílias endividadas</p></div><div class="flex-1 p-4 md:p-6 bg-white/10 rounded-lg"><p class="text-2xl md:text-3xl text-red-500">61%</p><p class="text-xs md:text-sm uppercase tracking-wide opacity-80 mt-1 md:mt-2">não poupam nada</p></div></div></div>',
